...
-- cadastra administrador - também foi dado acesso no auth0
...
-- veiculos para teste com valores ficticios
INSERT INTO vehicles (model_id, year, color, price, status) VALUES
(1, 1990, 'Branco', 1.99, 'AVAILABLE'),
(2, 1991, 'Preto', 1.98, 'AVAILABLE'),
(3, 1992, 'Vermelho', 1.97, 'SOLD'),
(4, 1993, 'Amarelo', 1.96, 'RESERVED');
